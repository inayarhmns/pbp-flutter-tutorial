                                            ...
                                            return Dialog(
                                                ...
                                                child: ListView(
                                                    ...
                                                    Center(
                                                        child:  Column(
                                                            children: <Widget>[
                                                            Text('Nama Lengkap: ' + _namaLengkap, style: TextStyle(color: Colors.green) ),
                                                            Text('. Umur: ' + '$umur' , style: TextStyle(color: Colors.green)),
                                                            if (jenjangSarjana) Text('Jenjang: Sarjana', style: TextStyle(color: Colors.green)),
                                                            if (jenjangDiploma) Text('Jenjang: Diploma', style: TextStyle(color: Colors.green)),
                                                            if (jenjangMagister) Text('Jenjang: Magister', style: TextStyle(color: Colors.green)),
                                                            if (jenjangDoktor) Text('Jenjang: Doktor', style: TextStyle(color: Colors.green)),
                                                            Text('Kelas PBP: ' + kelasPBP, style: TextStyle(color: Colors.green)),
                                                            if (_nilaiSwitch) 
                                                                const Text('Practice Mode: True', style: TextStyle(color: Colors.green))
                                                            else    
                                                                const Text('Practice Mode: False', style: TextStyle(color: Colors.green))
                                                            ,
                                                            ]  
                                                        )
